...
<body data-bs-theme="dark" class="position-relative">
    ...
    <header class="container-flude d-flex justify-content-center align-items-center" style="height: 80px;">
            ...
            <div class="user w-25 d-flex justify-content-end">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu shadow" style="background-color: var(--primary-color);">
                        ...
                        <li>
                            <form action="" method="post">
                                <button class="dropdown-item text-white bold" type="button" name="add_admin">Thêm Admin</button>
                            </form>
                        </li>
                        <li>
                            <form action="" method="post">
