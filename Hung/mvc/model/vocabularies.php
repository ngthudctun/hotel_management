...
class Vocabularies
{
    ...
    {
        $sql = 'SELECT words.*, topics.topic_name, partsofspeech.part_of_speech_name, partsofspeech.acronym FROM words
    ...
    function getLimitWordsTopics($limit)
    {
        $sql = "SELECT words.*, topics.topic_name, partsofspeech.part_of_speech_name, partsofspeech.acronym FROM words
            JOIN topics ON words.topic_id=topics.topic_id
            JOIN partsofspeech ON words.part_of_speech_id = partsofspeech.part_of_speech_id
    ...
    {
        $sql = "select * from topics
            WHERE topics.topic_name like '%$topic%'";
        return $this->conn->getAll($sql);
    }
