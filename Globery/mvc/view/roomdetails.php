        ...
        <div class="col-sm-6 col-md-8">
            ...
            <div class="card mb-3">
                ...
                <div class="row g-0 m-3">
                    <div class="col-md-2">
                    <img src="./mvc/view/img/<?php echo $row['image_room'] ?>" alt="" class="img-fluid rounded-start" style="width: 100%;">
                    </div>
                    <div class="col-md-8">
                    ...
                    <div class="d-flex">
                        <div class="d-flex flex-column">
                            <h5 class="mt-1">Phòng <?php echo $row['type_name'] ?></h5>
            ...
            <div class="card ms-3 position-sticky" style="top: 10px;">
                <div class="card-body">
                    <div class="d-flex">
                        ...
                        <span class="text-danger fw-bolder fs-5 text-end ms-auto"><?php echo $getRoomHotel[0]['price'] ?> VND</span>
                    </div>
